...
export async function tauriGet<T = any>(
    ...
    try {
        ...
        logger.general.warn('tauriGet plugin-store error, falling back to localStorage::', e)
...
export async function tauriSet<T = any>(
    ...
    try {
        ...
        logger.general.warn('tauriSet plugin-store error, falling back to localStorage:', e)
